#task: take foldername from user and display sizes of all files
#getsize() : gives size of file
    ...
    if(exist == True):
        for foldername, subfoldername, filename in os.walk(DirName):
            ...
            for name in filename:
                ...
                print("File size is : ", os.path.getsize(os.path.join(foldername, name)))
                print()
    else:
